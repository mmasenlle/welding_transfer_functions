...
% load('ss_vars_2d_v001_q100000_b0');
% v=0.001;
% q=100000;

% load('ss_vars_2d_v002_q100000_b0');
% v=0.002;
% q=100000;

% load('ss_vars_2d_v003_q100000_b0');
% v=0.003;
% q=100000;

% load('ss_vars_2d_v002_q50000_b0');
% v=0.002;
% q=50000;

load('ss_vars_2d_v002_q200000_b0');
v=0.002;
q=200000;
